...
public class BookingsController {
	...
	@PostMapping
	public ResponseEntity<String> bookEquipment(@RequestBody BookingsRequestDTO bookingsRequest)throws EquipmentNotFoundException,UserNotFoundException, RenterNotFoundException, LenderNotFoundException{
