...
public class EquipmentController {
	...
	public ResponseEntity<List<EquipmentDTO>> searchEquipment(@RequestBody SearchEquipmentDTO searchEquipmentDTO){
		...
		List<EquipmentDTO> equipmentListDTO = equipmentService.searchEquipment(searchEquipmentDTO);
		
		return ResponseEntity.status(HttpStatus.OK).body(equipmentListDTO);
