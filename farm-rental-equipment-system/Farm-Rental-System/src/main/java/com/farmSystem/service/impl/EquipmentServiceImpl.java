...
public class EquipmentServiceImpl implements EquipmentService {
	...
	public int saveEquipment(EquipmentDTO equipmentDTO) throws Exception {
		...
		Equipment equipment = equipmentMapper.equipmentDTOToEquipmentEntity(equipmentDTO);
	...
	public List<EquipmentDTO> findAllEquipments(){
		...
		return equipmentList.stream().map(equipment -> equipmentMapper.equipmentEntityToEquipmentDTO(equipment))
